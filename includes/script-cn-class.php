...
if (isset($token_data) and isset($check_seller_number_notify) and $check_status == "yes") {?>
...
var raw  = JSON.stringify({
  "fullnameto":"<?php echo $customer_first_name ?>",
  "phoneto":"<?php echo $customer_phone ?>" ,
  "title": "<?php echo $entete_message ?>" ,
  "senderkey":"<?php echo $cle_marchand ?>" ,
  "outemail": "<?php echo $token_data ?>" ,
  "cauris": "40",
  "message": ' <?php echo $check_customer_message ?>',
